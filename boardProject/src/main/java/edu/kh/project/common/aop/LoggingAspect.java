...
public class LoggingAspect {
	...
	public void beforeController(JoinPoint jp) {
		...
		// -> 메모리 효율 좋게 문자열 수정, 누적 등이 가능
		StringBuilder sb = new StringBuilder();

		sb.append(String.format("[%s.%s] 요청 / ip : %s", 
	 ...
	 *   (다른건 다 void)
	 * 2) 메서드 종료 시 proceed() 메서드 호출 값을 반환 해야함!
	 */
	@Around("PointcutBundle.serviceImplPointcut()")
	public Object aroundServiceImpl(ProceedingJoinPoint pjp) 
			throws Throwable {
