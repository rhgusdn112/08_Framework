...
// 동기식 -> 서버가 응답(화면)을 주면 서버가 깜빡거리면서 화면이 변함
//  -> form 태그
// 비동기식 -> 멀티태스킹 // 화면을 보여주면서 다른 요청들을 처리할 수 있음 이후 결과 데이터만 돌려줌
//  -> ajax
/*  * 삭제 버튼 클릭 시 *
  ...
  - 서버(Java)에서 로그인 한 회원의 회원 번호를 얻어와서
